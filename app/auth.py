...
def login_form():
    ...
    with col2:
        ...
        st.markdown(f'<h1 style="text-align: center; background: linear-gradient(90deg, {COLORS['primary']}, {COLORS['secondary']});
        -webkit-background-clip: text;
        -webkit-text-fill-color: transparent;
        font-size: 3em;"> JEK2 RECORDS</h1>', unsafe_allow_html=True)
